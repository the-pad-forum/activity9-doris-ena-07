...
const Posts = () => {
  ...
  return (
    <>
      ...
      <div className='flex flex-row items-center gap-4 text-black mt-5 justify-end pb-2'>
        <button className= {` bg-indigo-500 px-4 py-1 border-indigo-900 border-solid border-[1px] ${currentPage === 1? 'text-black/30' :'text-white' }`} onClick={handlePrevPage}>Prev.</button>
        <p>{currentPage}</p>
